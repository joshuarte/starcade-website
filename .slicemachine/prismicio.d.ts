...
export type AllDocumentTypes = HomeDocument | NewsDocument | PageDocument;
/**
...
declare module "@prismicio/client" {
    ...
    namespace Content {
        export type { HomeDocumentData, HomeDocument, NewsDocumentData, NewsDocument, PageDocumentData, PageDocumentDataSlicesSlice, PageDocument, AllDocumentTypes, TextBlockSliceDefaultPrimary, TextBlockSliceDefault, TextBlockSliceVariation, TextBlockSlice };
    }
}
